...
STOPWORDS = set(["的", "是", "有", "多少", "哪些", "我", "什么", "你", "知道", "啊", "给出", "以及", "之", "从", "找", "找到", "哪里", "该", "各", "所有", "时", "长",
"来自", "一下", "吗", "在", "请问", "或者", "或", "想", "和", "为", "后", "那个", "是什么", "这", "对应", "并", "于", "找出", "起来", "她们", "她", "那么", "多少次",
"被", "了", "并且", "都", "呢", "前", "哪个", "还有", "这个", "上", "下", "就是", "其", "它们", "及", "所", "所在", "那些", "他", "他们", "如果", "等于", "种", "可",
"没有", "它", "要求", "谁", "了解", "不足", "时候", "个", "能", "那", "问", "中", "这些", "比", "拥有", "且", "同时", "这里", "那里", "啥", "由", "由于", "按", "占",
"没", "可以", "一共", "哪", "其他", "叫", "多少年", "分别", "及其", "当", "之后", "都是", "过", "与", "位于", "额", "几个", "到", "每", "数", "最多", "最少", "主要",
"最长", "每个", "总", "的话", "人", "最高", "不少", "属于", "不", "不是", "值", "包含", "各个", "但", "但是", "不在", "多多少", "高", "低", "平均", "含", "加", "按照",
"最短", "小于", "大于", "超过", "最低", "少于", "总和", "至少", "多于", "最小", "多", "最", "总共", "不到", "不止", "正好", "低于", "高于", "超", "少", "每一个", "所属"])
