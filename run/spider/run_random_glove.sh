...
python -u scripts/spider/train_and_eval_random.py --task $task --dataset 'spider' --db_dir 'data/spider/database' --seed $seed --device $device $testing $read_model_path $read_order_path \
