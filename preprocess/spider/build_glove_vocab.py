...
def construct_vocab_from_dataset(dataset_path, table_path, mwf=4, reference_file=None, output_path=None, sep='\t'):
    words = []
...
if __name__ == '__main__':
    ...
    construct_vocab_from_dataset(dataset_path, table_path, mwf=args.mwf, reference_file=args.reference_file, output_path=args.output_path)
