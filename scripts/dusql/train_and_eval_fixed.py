...
train_dataset, dev_dataset = Example.load_dataset('train', args.order_seed, True), Example.load_dataset('dev')
...
def decode(choice, output_path, acc_type='sql', value_fscore=False, schema_acc=False):
