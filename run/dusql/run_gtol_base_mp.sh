...
plm=chinese-macbert-large # chinese-bert-wwm-ext
...
python -u scripts/dusql/train_and_eval_gtol_mp.py --task $task --dataset 'dusql' --db_dir 'data/dusql/db_content.json' --seed $seed $testing $read_model_path $read_order_path \
    --gtol_size $gtol_size --n_best $n_best --order_method $order_method --cumulate_method $cumulate_method \
