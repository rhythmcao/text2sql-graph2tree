...
# python3 -u scripts/spider/eval_from_ast.py --db_dir 'data/spider/database-testsuite' --table_path 'data/spider/tables.original.json' --read_model_path $read_model_path --output_path $output_path
