...
class CachedTranslator():
    ...
    def __init__(self, cache_folder=None) -> None:
        ...
        self.cache_folder = cache_folder if cache_folder is not None else DATASETS['cspider']['cache_folder']
...
class InputProcessor():
    ...
    def __init__(self, encode_method='lgesql', db_dir='data/cspider/db_content.json', db_content=True, bridge=False, **kargs):
...
if __name__ == '__main__':
    ...
    # pickle.dump(tables, open(os.path.join(DATASETS['cspider']['data'], 'tables.bin'), 'wb'))
    # tables = pickle.load(open(os.path.join(DATASETS['cspider']['data'], 'tables.bin'), 'rb'))
    ...
    zh2en_path, en2zh_path = os.path.join(DATASETS['cspider']['cache_folder'], 'translation.zh2en'), os.path.join(DATASETS['cspider']['cache_folder'], 'translation.en2zh')
