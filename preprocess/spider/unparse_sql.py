...
if __name__ == '__main__':
    ...
    reconstruct_dataset(unparser, 'data/spider/train.json', 'train_recovered.sql', tables)
    reconstruct_dataset(unparser, 'data/spider/dev.json', 'dev_recovered.sql', tables)
