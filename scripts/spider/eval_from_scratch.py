...
Example.configuration('spider', plm=params.plm, encode_method=params.encode_method, tables=tables, table_path=args.table_path, db_dir=args.db_dir, ts_order_path=os.path.join(args.read_model_path, 'order.bin'))
...
# pickle.dump(Example.tables, open(os.path.join(args.read_model_path, 'tables.bin'), 'wb'))
# pickle.dump(dataset, open(os.path.join(args.read_model_path, 'dataset.bin'), 'wb'))
