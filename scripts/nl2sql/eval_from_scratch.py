...
parser.add_argument('--output_path', default='nl2sql.sql', help='output predicted sql file')
...
Example.configuration('nl2sql', plm=params.plm, encode_method=params.encode_method, ts_order_path=os.path.join(args.read_model_path, 'order.bin'))
# load test dataset
