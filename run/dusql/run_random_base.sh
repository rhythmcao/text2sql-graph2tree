...
read_model_path="--read_model_path exp/task_random__model_rgatsql__dataset_dusql/view_global__plm_chinese-macbert-base__gs_5__nb_1__om_all__cm_sum__bs_20__lr_0.0002_ld_0.8__l2_0.1__me_160__mn_5.0__bm_5__seed_${1}__os_1024/"
...
python -u scripts/dusql/train_and_eval_random.py --task $task --dataset 'dusql' --db_dir 'data/dusql/db_content.json' --seed $seed --device $device $testing $read_model_path \
