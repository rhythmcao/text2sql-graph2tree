...
python -u scripts/dusql/train_and_eval_gtol.py --task $task --dataset 'dusql' --db_dir 'data/dusql/db_content.json' --seed $seed --device $device $testing $read_model_path $read_order_path \
