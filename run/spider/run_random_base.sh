...
read_model_path='--read_model_path exp/task_random__model_rgatsql__dataset_spider/view_global__plm_electra-base-discriminator__gnn_512_x_8__share__head_8__share__gs_5__nb_5__om_controller__cm_sum__bs_20__lr_0.0002_ld_0.8__l2_0.1__ls_0.15__wp_0.1__sd_linear__me_160__mn_5.0__bm_5__seed_111__os_1024/'
...
python -u scripts/spider/train_and_eval_random.py --task $task --dataset 'spider' --db_dir 'data/spider/database' --seed $seed --device $device $testing $read_model_path \
