...
python -u scripts/wikisql/train_and_eval.py --task $task --dataset 'wikisql' --seed $seed --device $device $ddp $testing $read_model_path $read_ts_order_path $read_canonical_action_path \
